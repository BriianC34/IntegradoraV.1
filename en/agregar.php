...
<header id="header">
  ...
  <tbody>
  <form action="proceso_agregar.php" method="POST">
    <tr>
      <td><input type="text" style="height:50px; width:220px;" value="" name="producto"></td>
      <td><input type="text" style="height:70px; width:525px;" value="" name="informacion"></td>
      <td><input type="number" style="height:50px; width:80px;" value="" name="precio"></td>
      <td><input type="number" style="height:50px; width:80px;" value="" name="tipo"></td>
      <td><input type="text" disabled style="height:50px; width:80px;" value="1"></td>
    </tr>
    </tbody>
</table>
<a href="inventario.php" class="btn btn-custom btn-lg page-scroll" style="margin: 50px; background:red">Cancel</a>
