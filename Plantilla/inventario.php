...
$platillos="SELECT * FROM platillos_view_edit";
$refrescos="SELECT * FROM refrescos_view_edit";
...
<header id="header">
        ...
        <div class="row">
          <div class="intro-text">
            ...
            <h2 id="platillos" style="font-family: Cambria, Cochin, Georgia,
             ...
             style="margin: 50px;">Agregar producto</a>
             <p style="font-family: Cambria, Cochin, Georgia,
             Times, 'Times New Roman', serif;  color:aliceblue; font-size: 25px;">El estatus significa la disponibilidad del producto. Por ejemplo: <br>
            Estatus = 1 (Quiere decir que sí existen). <br>
            Estatus = 0 (Quiere decir que no hay diponibles).</p>
    <div class="tablas">
  ...
  <tbody>
    <tr><?php 
      ...
      <td><a href="actualizar.php?id=<?php echo $row['id_menu'];?>">Actualizar</a></td>
